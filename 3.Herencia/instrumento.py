class Instrumento:
    # Constructor
    def _init_(self, tipo, marca, material_fabricacion, precio):
        self.tipo = tipo
        self.marca = marca
...
class Guitarra(Instrumento):  # Subclase Guitarra
    # Constructor
    def _init_(self, tipo, marca, material_fabricacion, precio, numero_cuerdas):
        super()._init_(tipo, marca, material_fabricacion, precio)  # Llamada al constructor de la superclase
...
objeto_guitarra = Guitarra('Eléctrica', 'Fender', 'Madera', 890.000, 6)
